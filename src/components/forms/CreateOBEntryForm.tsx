// src/components/forms/CreateOBEntryForm.tsx
'use client';
...
interface CreateOBEntryFormProps {
  user: any;
  onClose: () => void;
  onSuccess: () => void;
}

export default function CreateOBEntryForm({
  user,
  onClose,
  onSuccess,
}: CreateOBEntryFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setError(data.error || 'Failed to create OB entry');
      }
    } catch (err) {
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full my-8">
        ...
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">Create OB Entry</h2>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-gray-900">Witnesses (Optional)</h3>
              <button
                type="button"
                onClick={addWitness}
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="text-lg font-semibold text-gray-900">Suspects (Optional)</h3>
              <button
                type="button"
                onClick={addSuspect}
                className="flex items-center gap-2 text-blue-600 hover:text-blue-700"
